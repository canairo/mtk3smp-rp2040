...
#if TK_SUPPORT_SMP
/*
 * Processor the caller is running on, numbered from 1 to match the SMP
 * T-Kernel convention used by TP_PRC1 / TP_PRC2.
 */
SYSCALL INT tk_get_prc( void )
{
	return (INT)knl_current_core() + 1;
}
#endif
